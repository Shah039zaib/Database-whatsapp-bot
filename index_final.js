    ...
    try {
        ...
        sock.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                // Logged out — fresh credentials chahiye
                if (code === DisconnectReason.loggedOut) {
                    ...
                    console.log('🔄 Logged out — auth clear, fresh start...');
                    setTimeout(startBot, 5000);

                // undefined code — Upstash credentials invalid hain — clear karo aur QR lo
                } else if (!code || code === undefined) {
                    botStatus = 'reconnecting';
                    console.log('⚠️ Undefined disconnect — credentials clear karke fresh QR le raha hai...');
                    try {
                        await redisSet('wa_auth_state', {});
                        await redisSet('wa_creds', null);
                    } catch (e) {}
                ...
                // 405 — IP block — thodi der baad try karo
                } else if (code === 405) {
                    botStatus = 'reconnecting';
                ...
                // Baaki sab errors
                    ...
                    botStatus = 'reconnecting';
                    console.log(`🔄 10sec mein reconnect... code: ${code}`);
